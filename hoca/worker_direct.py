...
def build_worker_direct_prompt(
    *,
    ...
    prompt = (
        ...
        "9. After one relevant validation command passes, stop immediately. Do not continue exploring, broaden validation, or make optional edits.\n"
        "10. Finish with a concise summary, validation, changed files, and any blocker.\n\n"
        "Safety:\n"
