...
def build_worker_direct_prompt(
    *,
    ...
    prompt = (
        ...
        "9. After one relevant validation command passes for the changed scope, stop working immediately. "
        "Do not continue exploring, re-running broader validation, or making optional edits.\n"
        "10. Finish with a concise implementation summary, validation performed, changed files, and any blocker.\n\n"
        "Safety constraints:\n"
